...
export default function PaymentProof() {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await uploadProof.mutateAsync({ orderId: order.id, dataUrl: await toDataUrl(file), fileName: file.name, transactionReference, note });
      setSuccess(true);
      setError("");
    } catch (reason) {
