...
const methods = [
  { name: "واتساب", note: "أفضل طريقة للدفع — تواصل مباشر مع فريق المتجر", icon: MessageCircle },
...
export default function Checkout() {
  ...
  const { user } = useAuth();
  const [payment, setPayment] = useState<(typeof methods)[number]["name"]>("واتساب");
