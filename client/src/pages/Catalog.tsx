...
const categories = ["الكل", "كتب", "كتب إلكترونية", "ملابس", "أجهزة"];
...
export default function Catalog() {
  ...
  const filtered = useMemo(() => products.filter(product => {
    ...
    const digitalBook = product.productType === "كتب إلكترونية" || product.tags.includes("كتب إلكترونية") || product.tags.includes("كتاب إلكتروني");
    const categoryMatches = selectedCategory === "الكل" || (selectedCategory === "كتب إلكترونية" ? digitalBook : product.productType === selectedCategory || product.tags.includes(selectedCategory));
